...
function New-ClaudeSkillText {
    ...
    $lines += @(
        ...
        "---",
        "",
        "<!-- Generated from ../../.agents/skills/$SkillName/SKILL.md. Do not edit manually; run DataverseLabelTranslator.Scripts/sync-ai-config.ps1. -->",
        "",
...
if ($Check -and $drift.Count -gt 0) {
    ...
    throw "AI generated adapters are out of sync. Run DataverseLabelTranslator.Scripts/sync-ai-config.ps1."
}
