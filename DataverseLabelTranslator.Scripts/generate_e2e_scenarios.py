    ...
    for r_idx, label, val in row_data:
        ...
        if label == "Detailed Steps":
            ...
            for idx_step, step in enumerate(steps_list):
                ...
                if "[ðŸ“· HÃŒNH áº¢NH" in step_str or "[ðŸ“· SCREENSHOT" in step_str:
...
def build_e2e_document():
    ...
    steps_0 = (
        ...
        "+ [ðŸ“· HÃŒNH áº¢NH HÆ¯á»šNG DáºªN: Anh PhÆ°á»›c hÃ£y chá»¥p áº£nh mÃ n hÃ¬nh thÃ´ng bÃ¡o lá»—i phÃ¢n quyá»n hoáº·c giao diá»‡n bá»‹ khÃ³a khi Ä‘Äƒng nháº­p báº±ng tÃ i khoáº£n khÃ´ng cÃ³ quyá»n Admin/Customizer rá»“i paste vÃ o Ä‘Ã¢y.]\n"
    ...
    steps_1 = (
        ...
        "+ [ðŸ“· HÃŒNH áº¢NH HÆ¯á»šNG DáºªN: Anh PhÆ°á»›c hÃ£y má»Ÿ app, load Attributes cá»§a Account vÃ  chá»¥p báº£ng grid chá»©a dá»¯ liá»‡u rá»“i paste vÃ o Ä‘Ã¢y.]\n"
        "+ Double-click in the target language column (e.g. Vietnamese) for a few attribute rows (e.g. Name -> TÃªn CÃ´ng Ty, Main Phone -> Äiá»‡n Thoáº¡i ChÃ­nh).\n"
        "+ Observe the cell highlight (dirty indicator).\n"
        "+ Click the Save button in the top toolbar. Wait for the success dialog.\n"
        "+ [ðŸ“· HÃŒNH áº¢NH HÆ¯á»šNG DáºªN: Anh PhÆ°á»›c hÃ£y chá»¥p áº£nh mÃ n hÃ¬nh thÃ´ng bÃ¡o Save thÃ nh cÃ´ng rá»“i paste vÃ o Ä‘Ã¢y.]\n"
    ...
    user_goals_3 = "+ Use advanced AI (Google, OpenAI, or Azure) to auto-translate empty cells in bulk, while ensuring technical terms and product names remain accurate."
    business_goals_3 = "+ Automate translation to cut down localization costs and timeline by 90%."
    steps_3 = (
        "+ Click the App Settings button in the toolbar.\n"
        "+ Configure your AI Provider (e.g. Google or OpenAI) by pasting your API Key and selecting/typing the model.\n"
        "+ Click Save on the settings dialog.\n"
        "+ [ðŸ“· HÃŒNH áº¢NH HÆ¯á»šNG DáºªN: Anh PhÆ°á»›c hÃ£y chá»¥p popup App Settings sau khi Ä‘iá»n khÃ³a API rá»“i paste vÃ o Ä‘Ã¢y.]\n"
        ...
        "+ [ðŸ“· HÃŒNH áº¢NH HÆ¯á»šNG DáºªN: Anh PhÆ°á»›c hÃ£y chá»¥p popup cáº¥u hÃ¬nh Auto Translate rá»“i paste vÃ o Ä‘Ã¢y.]\n"
    ...
    steps_4 = (
        ...
        "+ In the popup dialog, enter a base language term (e.g. 'Account') and its corresponding target translation (e.g. 'KhÃ¡ch hÃ ng' for Vietnamese).\n"
        "+ Click Save in the dictionary popup.\n"
        "+ [ðŸ“· HÃŒNH áº¢NH HÆ¯á»šNG DáºªN: Anh PhÆ°á»›c hÃ£y chá»¥p popup Dictionary Editor hiá»ƒn thá»‹ danh sÃ¡ch tá»« Ä‘iá»ƒn rá»“i paste vÃ o Ä‘Ã¢y.]\n"
    ...
    steps_5 = (
        ...
        "+ [ðŸ“· HÃŒNH áº¢NH HÆ¯á»šNG DáºªN: Anh PhÆ°á»›c hÃ£y chá»¥p thanh tráº¡ng thÃ¡i/loader khi Ä‘ang load Form Ä‘á»ƒ thá»ƒ hiá»‡n viá»‡c Ä‘á»•i ngÃ´n ngá»¯ rá»“i paste vÃ o Ä‘Ã¢y.]\n"
        "+ Verify that the form tab/section/field labels are loaded for all columns.\n"
        "+ Translate several form labels (e.g., General Tab -> ThÃ´ng tin chung, Summary -> TÃ³m táº¯t).\n"
        "+ Click Save.\n"
    ...
    # Save E2E Document
    version = "1.0.0.0"
    output_dir = rf"d:\github\DataverseLabelTranslator\DataverseLabelTranslator.Release\{version}\appsource\Test"
