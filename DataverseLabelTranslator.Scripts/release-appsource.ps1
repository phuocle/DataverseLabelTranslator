...
$ManagedSolutionZip = Join-Path $RepoRoot "DataverseLabelTranslator.Release\$SolutionVersion\dataverse\solutions\DataverseLabelTranslator_managed.zip"
$AppSourceRoot = Join-Path $RepoRoot "DataverseLabelTranslator.Release\$SolutionVersion\appsource"
...
function New-GeneratedImages {
    ...
    $siteAssets = Join-Path $RepoRoot "DataverseLabelTranslator.Site\assets"
