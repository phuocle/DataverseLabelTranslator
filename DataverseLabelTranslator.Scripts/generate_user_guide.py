...
def add_callout(doc, text, title="CHÃš Ã", hex_bg=COLOR_CALLOUT_BG, is_screenshot=False):
    p = doc.add_paragraph()
...
def build_document():
    ...
    add_callout(doc, "Anh PhÆ°á»›c hÃ£y má»Ÿ Power Apps portal hoáº·c app cá»§a anh, chá»¥p hÃ¬nh Icon hoáº·c giao diá»‡n chÃ­nh vÃ  thay tháº¿ vÃ o Ä‘Ã¢y.\nHÆ°á»›ng dáº«n chÃ¨n áº£nh: Click vÃ o Ä‘Ã¢y -> Insert -> Pictures -> Chá»n áº£nh Ä‘Ã£ chá»¥p.", "ðŸ“· HÃŒNH áº¢NH: LOGO / GIAO DIá»†N CHÃ€O Má»ªNG Cá»¦A APP", COLOR_SCREENSHOT_BG, is_screenshot=True)
    ...
    add_callout(doc, "Anh PhÆ°á»›c hÃ£y chá»¥p áº£nh danh sÃ¡ch App trong Power Apps portal, chá»‰ mÅ©i tÃªn vÃ o app 'Dataverse Label Translator' Ä‘á»ƒ ngÆ°á»i dÃ¹ng dá»… nhÃ¬n tháº¥y cÃ¡ch má»Ÿ app.", "ðŸ“· HÃŒNH áº¢NH: HÆ¯á»šNG DáºªN Má»ž APP", COLOR_SCREENSHOT_BG, is_screenshot=True)
    ...
    add_callout(doc, "Anh PhÆ°á»›c hÃ£y click má»Ÿ nÃºt App Settings trÃªn toolbar, chá»¥p áº£nh mÃ n hÃ¬nh Popup Ä‘iá»n API Key vÃ  cáº¥u hÃ¬nh App Settings Ä‘á»ƒ paste vÃ o Ä‘Ã¢y.", "ðŸ“· HÃŒNH áº¢NH: HÆ¯á»šNG DáºªN Cáº¤U HÃŒNH APP SETTINGS", COLOR_SCREENSHOT_BG, is_screenshot=True)
    ...
    add_callout(doc, "Anh PhÆ°á»›c hÃ£y báº¥m vÃ o Auto Translate, chá»¥p áº£nh Popup cáº¥u hÃ¬nh dá»‹ch tá»± Ä‘á»™ng (chá»n nguá»“n, Ä‘Ã­ch vÃ  cháº¿ Ä‘á»™ dá»‹ch) Ä‘á»ƒ paste vÃ o Ä‘Ã¢y.", "ðŸ“· HÃŒNH áº¢NH: DIALOG Cáº¤U HÃŒNH AUTO TRANSLATE", COLOR_SCREENSHOT_BG, is_screenshot=True)
    ...
    add_callout(doc, "Anh PhÆ°á»›c hÃ£y báº¥m vÃ o Manage Dictionary, chá»¥p áº£nh Popup hiá»ƒn thá»‹ danh sÃ¡ch tá»« vá»±ng Ä‘Ã£ lÆ°u trong Dictionary Ä‘á»ƒ chÃ¨n vÃ o Ä‘Ã¢y.", "ðŸ“· HÃŒNH áº¢NH: QUáº¢N LÃ Tá»ª ÄIá»‚N TRANSLATION DICTIONARY", COLOR_SCREENSHOT_BG, is_screenshot=True)
    ...
    add_callout(doc, "It is highly recommended to export a backup solution containing the target entity forms before executing the 'Remove Overridden Attribute Labels' command.", "ðŸ’¡ BEST PRACTICE: EXPORT BACKUP", "E8F8F5")
    
    version = "1.0.0.0"
    output_dir = rf"d:\github\DataverseLabelTranslator\DataverseLabelTranslator.Release\{version}\appsource\Documents"
