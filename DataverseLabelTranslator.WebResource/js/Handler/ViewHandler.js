(function (ViewHandler, undefined) {
    ...
    function AddLabelRecord(records, view) {
        var labels = view.labels && view.labels.Label ? view.labels.Label.LocalizedLabels : [];
    ...
    ViewHandler.Load = function () {
        ...
        var queryRequest = {
            ...
            queryParams:
                "?$filter=returnedtypecode eq '" +
                entityName.toLowerCase() +
                "' and iscustomizable/Value eq true&$orderby=savedqueryid asc"
        };
