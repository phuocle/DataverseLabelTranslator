...
display-name: "PL Unit Tests WebResource"
...
> Deprecated: this repository currently has no active JavaScript unit-test suite. Use this workflow only when the user explicitly asks to reintroduce web-resource tests.

Use this workflow when the user explicitly asks to reintroduce, run, verify, debug, or explain Vitest tests or coverage for Dataverse Label Translator.
