...
.DESCRIPTION
    Finds the most recent .coverage file in DataverseLabelTranslator.Server.Test\TestResults,
...
.PARAMETER CoverageDir
    Path to the TestResults directory. Defaults to "DataverseLabelTranslator.Server.Test\TestResults".
.PARAMETER OutputXml
    Path for the merged XML output. Defaults to "$CoverageDir\coverage.xml".
#>
param(
    [string]$CoverageDir = "DataverseLabelTranslator.Server.Test\TestResults",
    [string]$OutputXml = ""
)
