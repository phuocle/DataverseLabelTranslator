...
display-name: "PL Release 4 Deploy Azure"
...
Use this workflow when the user asks to run `Deploy Azure`, `/pl-release-4-deploy-azure`, upload the final AppSource ZIP to Azure Blob, or generate the Partner Center SAS URL.
