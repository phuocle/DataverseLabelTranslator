...
{
    [CrmPluginRegistration("pl_DataverseLabelTranslatorCustomActionAsync", "none", StageEnum.PostOperation, ExecutionModeEnum.Asynchronous, "", "DataverseLabelTranslator.Server.CustomActions.PostDataverseLabelTranslatorCustomActionAsyncAsynchronous", 1, IsolationModeEnum.Sandbox, PluginType = PluginType.CustomAction, DeleteAsyncOperation = true)]
    public class PostDataverseLabelTranslatorCustomActionAsyncAsynchronous : IPlugin
    {
        /*
        InputParameters:
        ...
        */
        ...
        //public PostDataverseLabelTranslatorCustomActionAsyncAsynchronous(string unSecureConfiguration, string secureConfiguration)
        //{
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            if (!string.Equals(context.MessageName, "pl_DataverseLabelTranslatorCustomActionAsync", StringComparison.OrdinalIgnoreCase)) throw new InvalidPluginExecutionException("MessageName does not equals pl_DataverseLabelTranslatorCustomActionAsync");
